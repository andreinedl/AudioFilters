...
#
# Script generated by Vivado on Sat May 02 12:57:43 +0300 2026
...
simulate()
{
  xsim block_design -key {Behavioral:sim_1:Functional:block_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_22f9.protoinst" -protoinst "protoinst_files/block_design.protoinst" -log simulate.log
}
