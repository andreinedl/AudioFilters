...
HD_PWD='D:/Vivado/AudioFilters/AudioFilters.runs/block_design_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_mdm_1_0.tcl
